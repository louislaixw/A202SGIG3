...
public class StandardActivityList extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (intValue){
            case 1:
                setContentView(R.layout.activity_handplank);
                break;
            ...
            case 3:
                setContentView(R.layout.activity_benchups);
                break;

            case 4:
                setContentView(R.layout.activity_bodytwist);
                break;
            ...
            case 7:
                setContentView(R.layout.activity_vcrunch);
                break;
            ...
            case 10:
                setContentView(R.layout.activity_windmills);
                break;

            case 11:
                setContentView(R.layout.activity_russiantwists);
                break;

            case 12:
                setContentView(R.layout.activity_heelt);
                break;

            case 13:
                setContentView(R.layout.activity_bodycrunch);
                break;
                    ...
                    builder.setTitle("Alert").setMessage("Are you sure you want to quit?").setCancelable(true)
                            .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    Intent intent = new Intent (StandardActivityList.this, MainActivity.class);
    ...
    private void startTimer() {
        ...
        cdTimer = new CountDownTimer(MTimeLeftMilli, 1000) {
            ...
            public void onFinish() {
                ...
                if(newValue<=7){
                    Toast.makeText(StandardActivityList.this, "Next Workout!", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(StandardActivityList.this, StandardActivityList.class);
                    ...
                    builder.setTitle("Alert").setIcon(R.drawable.trophy).setMessage("Congratulations! You have finished this workout session!" +
                            ...
                            .setPositiveButton("Return to Main Menu", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    String complete = "Standard Workout Completed - " + currentTime;
                                    reference.child(userId).child("completed").setValue(complete);
